<template>
  <div class="gallery-container fixed inset-0 bg-gradient-to-br from-black/95 to-gray-900/95 z-50 overflow-y-auto backdrop-blur-sm">
    <div class="max-w-7xl mx-auto p-6">
      ...
      <div class="flex justify-between items-center mb-8">
        <div class="flex items-center">
          ...
          <div>
            ...
            <p class="text-gray-300 text-sm mt-1">{{ photos.length }} photos captured</p>
          </div>
        </div>
        <button
      ...
      <div v-if="photos.length === 0" class="text-center py-20">
        <div class="bg-gradient-to-br from-gray-800/50 to-gray-900/50 rounded-3xl p-12 max-w-md mx-auto backdrop-blur-sm border border-white/10">
          <div class="bg-gradient-to-r from-purple-500 to-pink-500 p-4 rounded-full w-fit mx-auto mb-6">
      ...
      <div v-else class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
        ...
        >
          ...
          <div class="p-5 bg-gradient-to-t from-gray-900/95 to-gray-800/95 backdrop-blur-sm">
            <div class="flex justify-between items-center mb-4">
              <span class="text-white text-sm font-semibold capitalize bg-gradient-to-r from-purple-500 to-pink-500 px-4 py-1.5 rounded-full shadow-lg">
                {{ photo.filter }} filter
              </span>
              <span class="text-gray-300 text-xs font-medium">{{ formatDate(photo.timestamp) }}</span>
            </div>
