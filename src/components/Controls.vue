<template>
  <div class="controls grid grid-cols-1 sm:grid-cols-3 gap-6 mt-6 max-w-md mx-auto">
    <!-- Take Photo Button -->
    <div class="control-button-container flex flex-col items-center">
      <button
        @click="takePhoto"
...
export default {
  ...
  methods: {
    ...
    openGallery() {
      this.$store.commit('SET_SHOW_GALLERY', true)
    }
  }
}
</script>